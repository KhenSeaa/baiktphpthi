...
<div id="reviews" class="mt-8">
                                <section class="bg-white antialiased">
                                    <div class="mx-auto">
                                        ...
                                        <form class="mb-6 <?= $isReview ? 'block' : 'hidden' ?>" action="?act=review"
                                            method="POST">
                                            <div class="flex gap-x-6">
                                                <div
                                                    class="flex-1 py-2 px-4 mb-4 bg-white rounded-lg rounded-t-lg border border-gray-200">
                                                    ...
                                                    <textarea id="comment" name="content" rows="6"
                                                        class="resize-none px-0 w-full text-sm text-gray-900 border-0 focus:ring-0 focus:outline-none"
                                                        placeholder="Viết đánh giá ....." required></textarea>
                                                </div>
                                                <div>
                                                    <div class="flex space-x-1">
                                                        <svg id='star'
                                                            class="text-gray-200 cursor-pointer h-5 w-5 flex-shrink-0"
                                                            viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
                                                            <path fill-rule="evenodd"
                                                                d="M10.868 2.884c-.321-.772-1.415-.772-1.736 0l-1.83 4.401-4.753.381c-.833.067-1.171 1.107-.536 1.651l3.62 3.102-1.106 4.637c-.194.813.691 1.456 1.405 1.02L10 15.591l4.069 2.485c.713.436 1.598-.207 1.404-1.02l-1.106-4.637 3.62-3.102c.635-.544.297-1.584-.536-1.65l-4.752-.382-1.831-4.401z"
                                                                clip-rule="evenodd" />
...
d="M10.868 2.884c-.321-.772-1.415-.772-1.736 0l-1.83 4.401-4.753.381c-.833.067-1.171 1.107-.536 1.651l3.62 3.102-1.106 4.637c-.194.813.691 1.456 1.405 1.02L10 15.591l4.069 2.485c.713.436 1.598-.207 1.404-1.02l-1.106-4.637 3.62-3.102c.635-.544.297-1.584-.536-1.65l-4.752-.382-1.831-4.401z"
                                            ...
                                            <button type="submit" name="btn-review" id="review"
                                                class="inline-flex items-center py-2.5 px-4 text-xs font-medium text-center bg-sky-500 rounded-lg text-white">
                                                Đánh giá
                                            </button>
                                            <button type="reset" id="cancel-review"
                                                class="inline-flex items-center py-2.5 px-4 text-xs font-medium text-center bg-gray-200 rounded-lg">
                                                Hủy
                                            </button>
                                        </form>
                                        <?php
