...
<head>
    ...
    <title><?= $typeProduct['name_category'] ?> - FiveStore</title>
                    ...
                    <div class="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-4">
                        ...
                        <div class="hidden lg:block">
                            ...
                            <form id="filter">
                                ...
                                <div class="mt-4">
                                    <button id="btn-filter" type="submit" class="bg-blue-500 hover:bg-blue-700 text-white py-1 px-6 rounded">Lọc</button>
                                </div>
                            </form>
                        </div>
                ...
                <div class="hidden sm:flex sm:flex-1 sm:items-center sm:justify-between mb-12">
                    <div>
                        <p class="text-sm text-gray-700">
                            Hiện thị
                            <span class="font-medium"><?= $products_page['current_page'] ?></span>
                            /
                            <span class="font-medium"><?= $products_page['page'] ?></span>
                            trang
                        </p>
                    </div>
