            ...
            <div class="mx-auto px-4 max-w-7xl py-6 sm:px-6 lg:px-8">
                ...
                <form id="form" method="POST" action="" enctype="multipart/form-data">
                                    ...
                                    <div class="grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                                        <div class="sm:col-span-3">
                                            <label for="first-name"
                                                ...
                                                lượng</label>
                                            <div class="mt-2">
                                                <input min="1" max="100000" required type="number" name="amount"
                                        ...
                                        <div class="sm:col-span-3">
                                            <label for="first-name"
                                                ...
                                                thước</label>
                                            <div class="mt-2">
                                                <input maxlength="100" required type="text" name="size"
                                                    class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 pl-2">
                                            </div>
                                        </div>
                                        <div class="sm:col-span-3">
                                            <label for="first-name"
                                                ...
                                                màu</label>
                                            <div class="mt-2">
                                                <input max="30" required type="text" name="color"
                                                    class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 pl-2">
                                            </div>
                                        </div>
                                        <div class="sm:col-span-3">
                                            ...
                                            <div class="mt-2">
                                                <input required type="color" name="code-color" value="#ffffff"
                                                    class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 pl-2">
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="mt-6 flex items-center justify-end gap-x-6">
                        ...
                        <button name="save&add-new" type="submit"
                            class="rounded-md bg-indigo-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Lưu
                            & Thêm mới</button>
                    </div>
                </form>
            </div>
        </main>
        <script> const images = document.querySelector('input[name="images[]"]')
