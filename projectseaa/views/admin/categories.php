        ...
        <header class="bg-white shadow ">
            <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8 flex item-center justify-between">
                ...
                <div class="flex gap-4">
                    <form action="">
                        <input type="hidden" name='act' value="categories" class="bg-gray-100 rounded-md px-2 py-2"
                                ...
                                foreach ($categories as $category) {
                                    ...
                                    <tr class="bg-white hover:bg-gray-50 ">
                                        ...
                                        <td class="flex items-center px-6 py-4">
                                            <a href="/admin?act=edit-category&id=<?= $id ?>"
