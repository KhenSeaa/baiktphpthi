        ...
        <header class="bg-white shadow">
            <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8 flex items-center justify-between">
                ...
                <div class="flex gap-4">
                    <form action="">
                        <input type="hidden" name='act' value="products" class="bg-gray-100 rounded-md px-2 py-2"
                            placeholder="Tìn kiếm danh nục">
                        <input type="search" name='q' class="bg-gray-100 rounded-md px-2 py-2"
                            placeholder="Tìn kiếm sản phẩm">
                        <button type="submit"
                ...
                <div class="mx-auto max-w-7xl py-6 sm:px-6 lg:px-8">
                    <div class="flex mb-4">
                        ...
                        <button type="button" id="delete-many"
                            class="text-white bg-red-600 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2">Ẩn</button>
                        <button type="submit" name="delete-many"
                            class="hidden text-white bg-red-600 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2">Ẩn</button>
                        <a href="?act=bin-products"
                            ...
                            <tbody>
                                ...
                                foreach ($products as $product) {
                                    ...
                                    <tr class="bg-white hover:bg-gray-50 ">
                                        <td class="w-4 p-4">
                                            <div class="flex items-center">
                                                <input value="<?= $id ?>" name="product-id[]" id="checkbox-table-search-1"
                                                    type="checkbox"
                                                    class="w-4 h-4 text-blue-600 bg-gray-100 rounded focus:ring-blue-500  ring-offset-gray-800 focus:ring-offset-gray-800 focus:ring-2  border-gray-600">
                                        ...
                                        <td class="flex items-center px-6 py-4 sticky right-0 bg-white border-l">
                                            <a href="/admin?act=edit-product&id=<?= $id ?>"
                                                class="font-medium text-blue-600  hover:underline">Sửa</a>
                                            <button type="button" id="delete-category" data-id="<?= $id ?>"
                                                class="font-medium text-red-600 hover:underline ms-3">Ẩn</button>
                                        </td>
                                    </tr>
                                    <?php
                                }
